    ...
    suspects: [
      {
        ...
        threads: [
          { id: "alibi", label: "Her night", hint: "Where she was, and what she saw, on Saturday night", ask: "Where exactly were you, and what did you see, on Saturday night?", startComposure: 100, presentOnly: true, truth: "She was on the phone with her lover Daniel for hours — and from the hall she saw Dr. Shaw take Cornelius his pills. She stonewalls until confronted with proof.", unlocks: ["margaret_affair", "margaret_saw_shaw"] },
        ],
      },
      {
        id: "julian",
        ...
        threads: [
          { id: "alibi", label: "His alibi", hint: "What he was really doing at the time of death", ask: "Where were you when Cornelius died, and can anyone confirm it?", startComposure: 25, truth: "On a long call to his bookmaker — on the phone records.", unlocks: ["julian_alibi"] },
          { id: "the_will", label: "The will", hint: "His finances and the inheritance", ask: "With your debts, what does Cornelius's will mean for you?", startComposure: 25, truth: "Deep gambling debts; about to be cut from the will. Real motive, but he didn't do it.", unlocks: ["julian_debt"] },
        ],
      },
      {
        id: "shaw",
        ...
        threads: [
          { id: "diagnosis", label: "Cause of death", hint: "Her medical conclusion about how he died", ask: "How can you be so sure it was a heart attack without a tox screen?", startComposure: 28, truth: "It was a digitalis overdose, not a heart attack — she is steering you away from a tox screen.", unlocks: ["tox_report"] },
          { id: "whereabouts", label: "Her Saturday night", hint: "Where she was the night he died", ask: "Did you see Cornelius at all on Saturday night?", startComposure: 100, presentOnly: true, truth: "She brought his pills and overdosed him.", unlocks: ["shaw_unravels"] },
          { id: "veridian", label: "Veridian", hint: "Her history with the company's drugs", ask: "What was your role in the Veridian safety trials?", startComposure: 100, presentOnly: true, truth: "She falsified Veridian's safety trials; Cornelius was about to expose her.", unlocks: ["shaw_motive"] },
        ],
      },
      {
        id: "thomas",
        ...
        threads: [
          { id: "loyalty", label: "The accounts", hint: "What he feared Cornelius had discovered", ask: "What did Cornelius confront you about in the accounts?", startComposure: 25, truth: "He embezzled from the household accounts; feared exposure, not a killer.", unlocks: ["thomas_embezzlement"] },
          { id: "that_night", label: "What he saw", hint: "What he noticed Saturday night and that afternoon", ask: "What did you see and hear around the house late that night?", startComposure: 26, truth: "Study light on past midnight; Shaw asked about the medication timing; he keeps the medication log; Mrs. Vane was on the telephone for hours.", unlocks: ["thomas_observation", "med_log", "margaret_phone"] },
        ],
      },
      {
        id: "iris",
        ...
        threads: [
          { id: "estrangement", label: "Her father", hint: "What really passed between them this weekend", ask: "What really passed between you and your father this weekend?", startComposure: 25, truth: "They reconciled Saturday afternoon — a note proves it; she's innocent.", unlocks: ["iris_note"] },
          { id: "the_file", label: "What he was afraid of", hint: "Something she noticed in his study", ask: "What was your father so afraid of in his study?", startComposure: 26, truth: "She saw his hidden Veridian file with Shaw's name on it.", unlocks: ["veridian_file"] },
        ],
      },
    ],
    clues: [
...
export function toPublicSeason(s) {
  return {
    ...
    suspects: s.suspects.map((p) => ({
      ...
      portrait: p.portrait,
      blurb: p.blurb,
      threads: p.threads.map((t) => ({ id: t.id, label: t.label, hint: t.hint, ask: t.ask })),
    })),
    board: {
